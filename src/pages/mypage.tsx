...
export const MyPage = () => {
  return (
    <div className="min-h-screen bg-[#030611] text-slate-100 font-mono flex">
      
      {/* 📋 サイドバー */}
      <aside className="w-64 border-r border-slate-800/60 bg-[#060913]/80 p-6 flex flex-col gap-8">
